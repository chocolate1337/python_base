...
import pprint
Indiana_Jones_stash = [
    ['Name', 'year of discovery', 'quantity'],
...
with open('external_data/Indiana_stash.csv', 'a', newline='') as out_file:
    ...
    try:
        ...
        print('В этом случается Пайтон выдает ошибку ValueError с перечнем ключей, в которых была ошибка')
...
Indiana_need_list = [
    {'Name:': 'Whip', 'Price:': '100', 'Quantity:': '1'},
